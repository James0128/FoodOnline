		...
		<table width="95%" height="170" border="0" cellpadding="0"
			...
			<tr>
				<td height="41" colspan="2"
					...
					|
					<a href="/foodonline/toShowMeal">网站首页</a> |
					...
					<a href="/foodonline/toMyOrders">我的订单</a> |
					<a href="/foodonline/logOut?type=userlogout">注销</a> &nbsp;&nbsp; &nbsp;&nbsp;
					<font style="color: red">欢迎您：${sessionScope.user.trueName }</font>					
					</s:if>
					<s:if test="#session.admin!=null">
					<a href="/foodonline/toAddMeal">添加餐品</a> |
					<a href="/foodonline/toManageMeal">管理餐品</a> |
					<a href="/foodonline/toManageOrders">订单处理</a> |
					<a href="/foodonline/logOut?type=adminlogout">注销</a> &nbsp;&nbsp; &nbsp;&nbsp;
				...
				<td valign="top" width="80%">
					...
					<table width="75%" cellspacing="0" cellpadding="4" align="center"
						...
						<tr>							
							...
							<td>
							    <a href="/foodonline/toUpdateMeal?meal.mealId=${mealItem.mealId}">修改</a>								
							</td>	
							<td>
								<a href="/foodonline/deleteMeal?meal.mealId=${mealItem.mealId}">删除</a>
							</td>				
						</tr>						
						</s:iterator>
	  ...
	  <tr>
		...
		<td width="80">
			<s:if test="pager.curPage>1">
				<A href='/foodonline/toManageMeal?pager.curPage=1&meal.mealseries.seriesId=${requestScope.seriesId}&meal.mealName=${requestScope.mealName}'>首页</A>&nbsp;&nbsp;
				<A href='/foodonline/toManageMeal?pager.curPage=${pager.curPage-1 }&meal.mealseries.seriesId=${requestScope.seriesId}&meal.mealName=${requestScope.mealName}'>上一页</A>
			</s:if>
		</td>
		<td width="80">
			<s:if test="pager.curPage < pager.pageCount">
				<A href='/foodonline/toManageMeal?pager.curPage=${pager.curPage+1}&meal.mealseries.seriesId=${requestScope.seriesId}&meal.mealName=${requestScope.mealName}'>下一页</A>&nbsp;&nbsp;
				<A href='/foodonline/toManageMeal?pager.curPage=${pager.pageCount }&meal.mealseries.seriesId=${requestScope.seriesId}&meal.mealName=${requestScope.mealName}'>尾页</A>
			</s:if>
		</td>
